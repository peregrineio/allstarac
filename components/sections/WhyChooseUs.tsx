    ...
    <section className="py-24 px-4 bg-midnight relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              {differentiators.map((item, index) => (
                <motion.div
                  ...
                  className="group relative bg-white/5 border border-white/10 hover:border-copper/50 p-6 transition-all duration-300"
                >
                  {/* Left accent bar */}
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-copper transform origin-bottom scale-y-0 group-hover:scale-y-100 transition-transform duration-500" />
          ...
          {/* Right Column — Family Photo Placeholder + Promise */}
          <motion.div
          ...
          >
            ...
            <div className="relative mb-8">
              <div className="aspect-[4/3] bg-gradient-to-br from-steel/20 to-steel/5 border-2 border-white/10 flex flex-col items-center justify-center">
              ...
              {/* Corner accent */}
              <div className="absolute -bottom-3 -right-3 w-24 h-24 border-b-4 border-r-4 border-copper" />
              <div className="absolute -top-3 -left-3 w-24 h-24 border-t-4 border-l-4 border-copper" />
            </div>
            ...
            <div className="bg-copper p-8 relative">
              ...
              <div className="mt-6 pt-4 border-t border-white/30">
                <p className="text-white font-semibold">— Leo & Gicela</p>
                <p className="text-white/60 text-sm">Owners, Allstar AC & Heating</p>
              </div>
            </div>
          </motion.div>
        </div>
